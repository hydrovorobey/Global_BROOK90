...
download.landcover = function (catchment_path, landcover_dir) {
  ...
  #lat = as.numeric(substr(coord[1],1,nchar(coord[1])-1))
  #lon = as.numeric(substr(coord[2],1,nchar(coord[2])-1))
  ...
  writeRaster(crop(lc,ext), 'lc.tiff')
...
download.soil = function (catchment_path, soil_dir) {
  ...
  url1 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=TEXMHT_M_sl1_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url2 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=TEXMHT_M_sl2_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url3 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=TEXMHT_M_sl3_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url4 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=TEXMHT_M_sl4_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url5 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=TEXMHT_M_sl5_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url6 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=TEXMHT_M_sl6_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url7 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=TEXMHT_M_sl7_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url8 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=BDRICM_M_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url9 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=CRFVOL_M_sl1_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url10 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=CRFVOL_M_sl2_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url11 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=CRFVOL_M_sl3_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url12 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=CRFVOL_M_sl4_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url13 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=CRFVOL_M_sl5_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url14 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=CRFVOL_M_sl6_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
  url15 = paste0('http://85.214.241.121:8080/geoserver/ows?service=WCS&version=2.0.1&request=GetCoverage&CoverageId=CRFVOL_M_sl7_250m&subset=Long(',ext[1],',',ext[2],')&subset=Lat(',ext[3],',',ext[4],')')
...
download.meteo = function (cds_user=NA, cds_key=NA, catchment_path, meteo_dir,
  ...
  request_builder = function(my_dates, my_var, my_time, my_area, my_target) {
    request = list('dataset'='reanalysis-era5-single-levels','product_type'='reanalysis','grid'='0.1/0.1',
